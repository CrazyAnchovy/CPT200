...
class gui(Frame):
    def __init__(self):
        ...
        self.label_Company = Label(self, text='                                                         Logical Software, LLC')
        self.label_Company.grid(row = 14, column = 16)

        self.label_fake = Label(self, text='  Sponsored Recipes:')
        self.label_fake.grid(row = 9, column = 1)
        
        self.label = Label(self, text='Ingredients on Hand:')
        ...
        self.information=Listbox(self, selectmode = EXTENDED, height=5, width=75)
        self.information.grid(row=7, column=3, columnspan=7, rowspan=3)
